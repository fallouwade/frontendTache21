      ...
      const mockData = [
        {
          ...
          service: "Plomberie",
          description:
            "Réparation d'un robinet qui fuit dans la salle de bain. Le robinet goutte constamment, ce qui entraîne un gaspillage d'eau et un bruit gênant.",
          date: "2023-05-15",
          status: "accepted",
        ...
        },
        {
          ...
          service: "Jardinage",
          description:
            "Tonte de pelouse et taille des haies. Le jardin mesure environ 200m² et les haies font le tour de la propriété.",
          date: "2023-05-20",
          status: "pending",
        ...
        },
        {
          ...
          service: "Électricité",
          description:
            "Installation d'un nouveau luminaire au plafond du salon. Le câblage est déjà en place, il faut juste installer le nouveau luminaire et s'assurer qu'il fonctionne correctement.",
          date: "2023-05-25",
          status: "rejected",
