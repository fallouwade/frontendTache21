...
function Sidebar({
  ...
  return (
    <div
      className={`fixed md:sticky top-0 left-0 h-screen z-0 w-72 transition-transform duration-300 ease-in-out transform ${
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="flex border-b border-gray-200">
          <Button
            color="light"
            className="flex-1 flex items-center justify-center py-2 sm:py-3 px-2 hover:bg-gray-50 transition-colors text-gray-600 gap-1 sm:gap-2 text-xs sm:text-sm"
          >
          ...
          <Button
            color={showFavorites ? "blue" : "light"}
            className="flex-1 flex items-center justify-center py-2 sm:py-3 px-2 hover:bg-gray-50 transition-colors gap-1 sm:gap-2 text-xs sm:text-sm"
          ...
          >
            <div className="space-y-1">
              {categories.map((cat) => (
                <Button
                  key={cat.id}
                  color={cat.id === category ? "blue" : "light"}
