...
const Temoignages = () => {
  ...
  const settings = {
    dots: true,           // Afficher les points de navigation en bas
    infinite: true,       // Loop infini
    speed: 500,           // Durée de la transition
    slidesToShow: 1,      // Nombre de slides visibles
    slidesToScroll: 1,    // Nombre de slides défilées à chaque fois
    centerMode: true,     // Centrer les slides
    centerPadding: "0",   // Padding autour de la slide centrale
    focusOnSelect: true,  // Sélectionner la slide au clic
    autoplay: true,       // Lancer le défilement automatique
    autoplaySpeed: 3000,  // Vitesse de l'auto-play (en ms)
    responsive: [
      {
    ...
    <div className="w-full px-4 md:px-8 py-8 md:py-12 bg-gray-100">
      ...
      <Slider {...settings}>
        ...
        <div className="flex justify-center items-center">
          <div className="w-full max-w-md bg-white p-6 rounded-xl shadow-lg transform transition-all hover:scale-105">
            <div>
        ...
        {/* Deuxième critique */}
        <div className="flex justify-center items-center">
          <div className="w-full md:w-[500px] bg-white p-6 rounded-xl shadow-lg transform transition-all hover:scale-105">
            <div>
